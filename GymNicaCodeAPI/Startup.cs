...
using GymNicaCodeAPI.Configuration;
...
namespace GymNicaCodeAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddValidatorsFromAssembly(typeof(GymNicaCode.Services.Validator.TraductorValidator).Assembly);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            //Swagger
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "GymNicaCode-Api v1"));
        }
    }
}
